...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Datenschutzerklärung von WHYEM Barber – Informationen zum Schutz Ihrer persönlichen Daten gemäß DSGVO.',
    url: 'https://whyem.at/datenschutz',
  },
  alternates: {
    canonical: 'https://whyem.at/datenschutz',
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <main className="legal-page">
      <div className="legal-container">
        ...
        <section>
          <h2>6. Online-Buchung</h2>
          <p>
            Für die Online-Terminbuchung nutzen wir den Dienst Treatwell. Wenn
            Sie über Treatwell einen Termin bei uns buchen, werden Ihre Daten
            (Name, Kontaktdaten, gebuchte Dienstleistung, Terminzeit) von
            Treatwell verarbeitet und an uns weitergegeben. Weitere
            Informationen finden Sie in der Datenschutzerklärung von Treatwell
            unter:
            <br />
            <a
              href="https://www.treatwell.at/info/datenschutz/"
              target="_blank"
              rel="noopener noreferrer"
            >
